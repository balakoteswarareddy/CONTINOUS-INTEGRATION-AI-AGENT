...
def complete_intake_answers() -> dict[str, object]:
    """Flat answers covering every required question in the Batch 1 intake schema.

    Single source of truth shared by the resolver, registry, and orchestrator
    tests (mirrors tests/unit/test_resolver/test_requirements_resolver.py).
    """
    return {
        "business_criticality": "high",
        "data_sensitivity": "confidential",
